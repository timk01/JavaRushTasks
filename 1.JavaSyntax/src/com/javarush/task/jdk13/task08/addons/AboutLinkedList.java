...
Как и в АЛ, в ЛЛ contains - O(n) ровно по той причине, что и выше. Сет и Гет- медленные - надо найти элемент.

ВЫВОД для ЛЛ:
быстрые: вставка в конец, в середину.
медленные: сет, гет, контейнс (в любом случае нужно найти элемент),
удаление из середины и добавление в середину (опять же, нужно найти элемент) медленное!
удаление/добавление ближе к концу/нчалу - быстрей
НО - на больших коллекциях все равно 2 последних - быстрее эррейлиста
